...
export const Login = () => {
  ...
  const [getCaptcha, { data: captcha, isSuccess: capchaRequestIsFinished }] = useLazyGetCaptchaQuery()
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <FormControl>
          ...
          <FormGroup>
            ...
            />
            {capchaRequestIsFinished && <Captcha url={captcha?.url} register={register} />}
